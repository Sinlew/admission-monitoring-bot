...
class Parser_yar:
    ...
    def get_list_links(self) -> dict:
        ...
        for el in html.select(
            "body > div.body-wrapper.clearfix > div.container.container-main.col-margin-top > div > div.col.col-mb-12.col-9.col-margin-bottom > table:nth-child(5) > tbody > tr > td "
        ):
            a = el.find_all("a")
            if len(a) != 0:
